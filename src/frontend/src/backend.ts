...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: ProductData): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addService(arg0: ServiceData): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getServices(): Promise<Array<ServiceData>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: ProductData): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateService(arg0: bigint, arg1: ServiceData): Promise<void> {
        if (this.processError) {
            try {
